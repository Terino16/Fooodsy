...
const Home = () => {
  ...
  return (
   ...
   { <input placeholder='  Pizza' className='w-[400px]  text-black' value={search} onChange={event => setsearch(event.target.value)} ></input>}<button className="bg-blue-500 hover:bg-yellow-700 text-white font-bold py-3 px-4 ">Search</button>
    </div>
    </div>
